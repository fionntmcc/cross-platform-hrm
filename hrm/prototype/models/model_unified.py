...
class PuzzleType(Enum):
    ...
    MAZE = auto()  # Prototype maze encoding, vocab=4 (wall, empty, start, goal)
...
class UnifiedHRM(nn.Module):
    ...
    def __init__(self, config: Optional[UnifiedHRMConfig] = None):
        ...
        self.register_buffer("z_L_init", torch.empty(1, 1, cfg.hidden_size))
        self.register_buffer("z_H_init", torch.empty(1, 1, cfg.hidden_size))
