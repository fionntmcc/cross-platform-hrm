...
def train_model(
    ...
    # Create HRM model
    model = HRM_4x4(
        hidden_dim=hidden_dim, n_outer_cycles=n_outer_cycles, n_inner_steps=n_inner_steps
    ).to(device)
    ...
    for epoch in range(1, num_epochs + 1):
        ...
        for puzzles, cells, digits in pbar:
            ...
            halt_penalty = model.get_halt_penalty(
                traces, target_iterations=n_outer_cycles * n_inner_steps
            )
