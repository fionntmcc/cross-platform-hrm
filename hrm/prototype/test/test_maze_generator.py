...
class TestGenerateMazeDataset:
    ...
    def test_generates_correct_number(self):
        ...
        dataset = generate_maze_dataset(
            num_mazes=5, width=15, height=15, min_path_length=5, seed=42, verbose=False
        )
    ...
    def test_dataset_shapes(self):
        ...
        dataset = generate_maze_dataset(
            num_mazes=num, width=width, height=height, min_path_length=5, seed=42, verbose=False
        )
    ...
    def test_seed_reproducibility(self):
        ...
        params = dict(
            num_mazes=3, width=15, height=15, min_path_length=5, seed=12345, verbose=False
        )
    ...
    def test_metadata_contains_required_fields(self):
        ...
        dataset = generate_maze_dataset(
            num_mazes=2, width=15, height=15, min_path_length=5, seed=42, verbose=False
        )
    ...
    def test_path_lengths_meet_minimum(self):
        ...
        min_path = 10
        dataset = generate_maze_dataset(
            num_mazes=5, width=20, height=20, min_path_length=min_path, seed=42, verbose=False
        )
...
class TestMazeIntegrity:
    ...
    def test_solution_path_is_valid(self):
        ...
        for i, (maze, solution, meta) in enumerate(
            zip(dataset["problems"], dataset["solutions"], dataset["metadata"])
        ):
